...
ListAdapter<MutableMap.MutableEntry<Pair<Int, String>, Boolean>, AdapterDeviceType.AttributesViewHolder>(
    ...
    inner class AttributesViewHolder(
        ...
        fun onBind(devType: MutableMap.MutableEntry<Pair<Int, String>, Boolean>) {
            binding.apply {
                txtLabel.text = devType.key.second
                if (devType.value) {
                ...
                root.setOnClickListener {
                    onItemClicked.invoke(devType.key)
                }
            }
        }
    }
