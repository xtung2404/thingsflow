...
class FragmentFlowScenManagement : FragmentBase<FragmentFlowManagementBinding>() {
    ...
    private val flowSceneList: ArrayList<FlowScene> = arrayListOf()
    ...
    override fun initView() {
        ...
        binding.apply {
            ...
            val flowScene1 = FlowScene()
            flowScene1.apply {
                id = "1"
                name = "hihihihi"
            }
            flowSceneList.add(flowScene1)
            val flowScene2 = FlowScene()
            flowScene2.apply {
                id = "2"
                name = "hih2ihihi"
            }
            flowSceneList.add(flowScene2)
            val flowScene3 = FlowScene()
            flowScene3.apply {
                id = "3"
