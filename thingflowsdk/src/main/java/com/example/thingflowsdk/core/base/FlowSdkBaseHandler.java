package com.example.thingflowsdk.core.base;
...
public interface FlowSdkBaseHandler {
    ...
    FlowScenarioHandler flowScenarioHandler();
    FlowBindingHandler flowBindingHandler();
